...
class DonationRepositoryImpl extends DonationRepository {
  ...
  }, fallback: 'Failed to record donation.');
  ...
  }, fallback: 'Failed to load donation history.');

  @override
  Future<Either<Failure, void>> reactivateDonor(String uid) => guard(() async {
    ...
    await batch.commit();
    return const Right(null);
  }, fallback: 'Failed to reactivate donor.');
